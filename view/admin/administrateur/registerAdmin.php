...
<div class="modal fade" id="addadminprofile" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <!-- modal formulaire ajoute admin -->
          <form action="./?path=admin&action=traitement-inscription-admin" method="POST" class="row needs-validation" novalidate>
            ...
            <div class="row">
              ...
              <div class="col-md-6 form-group">
                ...
                <input type="email" id="validationCustom02" name="email" class="form-control" placeholder="Entrez Email" required>
              </div>

              <div class="col-md-6 form-group">
                <label for="validationCustom01">* Nom</label>
                <input type="text" id="validationCustom03" name="nom" class="form-control" placeholder="Entrez Nom" required>
              </div>

              <div class="col-md-6 form-group">
                <label for="validationCustom01">* Prénom</label>
                <input type="text" id="validationCustom04" name="prenom" class="form-control" placeholder="Entrez Prénom" required>
              </div>
              ...
              <div class="col-md-6 form-group">
                <label for="validationCustom01">* Confirmation</label>
...
<div class="container-fluid">
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 fw-bold text-primary">Profil d'Admin
...
<?php include_once("listAdmin.php"); ?>
